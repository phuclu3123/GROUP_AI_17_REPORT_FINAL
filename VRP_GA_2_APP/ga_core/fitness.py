...
DEFAULT_INVALID_EDGE_PENALTY: float = 1_000_000.0
DEFAULT_CAPACITY_PENALTY_WEIGHT: float = 10_000.0
DEFAULT_TIME_WINDOW_PENALTY_WEIGHT: float = 100.0
            ...
            if use_tw and time_windows and service_times:
                ...
                if c2 not in depot_set:
                    ...
                    if current_time > due:
                        ...
                        penalty_cost += (current_time - due) * time_window_penalty_weight
                        total_conflicts += 1 # Vi phạm thời gian
 
                    current_time += service_times.get(c2, 0)
 
        # ── Capacity Penalty (CVRP) ───────────────────────────────────
        if use_capacity and route_demand > max_capacity:
...
def evaluate_population(
    ...
    for chrom in population:
        evaluate(
            ...
            time_windows, service_times, use_tw, use_capacity,
